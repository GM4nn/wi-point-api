...
EXCLUDE_TABLES = {
    ...
    "place", "state", "county", "cousub", "edges", "faces",
    "addr", "addrfeat", "featnames", "place_lookup", "county_lookup",
    "countysub_lookup", "state_lookup", "zip_lookup", "zip_lookup_all",
    ...
    "tract", "bg", "tabblock", "tabblock20", "zcta5",
}
